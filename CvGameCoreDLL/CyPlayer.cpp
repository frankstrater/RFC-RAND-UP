...
//Rhye RFCRAND - start
void CyPlayer::setMinorCiv(bool bMinorNationCiv)
{
	if (m_pPlayer)
		m_pPlayer->setMinorCiv(bMinorNationCiv);
}
//Rhye - end
...
//Rhye - start RFCRAND
int CyPlayer::AI_blindSettlersMap(int iX, int iY, bool bStartingLoc)
{
	return m_pPlayer ? m_pPlayer->AI_blindSettlersMap(iX, iY, bStartingLoc) : -1;
}
//Rhye - end
...
int CyPlayer::getSettlersCoords(int index)
{
	return m_pPlayer ? m_pPlayer->getSettlersCoords(index) : -1;
}
int CyPlayer::getSettlersModifiers(int index)
{
	return m_pPlayer ? m_pPlayer->getSettlersModifiers(index) : -1;
}
int CyPlayer::getSettlersModifiersNorm(int index)
{
	return m_pPlayer ? m_pPlayer->getSettlersModifiersNorm(index) : -1;
}
...
void CyPlayer::setBirthTurn(int i)
{
	if (m_pPlayer)
		m_pPlayer->setBirthTurn(i);
}
//Rhye - end
