...
##                                iCiv = con.iNumMajorPlayers/2 + i/2  
                        if (iCiv >= 0 and iCiv < con.iNumMajorPlayers):
                                if (gc.getPlayer(iCiv).isAlive() and iGameTurn >= gc.getPlayer(iCiv).getBirthTurn()+15): #RFCRAND
                        ...
                        if (iCiv1 >= 0 and iCiv1 < con.iNumMajorPlayers):
                                if (gc.getPlayer(iCiv1).isAlive() and iGameTurn >= gc.getPlayer(iCiv1).getBirthTurn()+15): #RFCRAND
                                        if (not gc.getTeam(gc.getPlayer(iCiv1).getTeam()).isHasTech(con.iElectricity)):
                                                self.decay(iCiv1)
                        if (iCiv2 >= 0 and iCiv2 < con.iNumMajorPlayers):
                                if (gc.getPlayer(iCiv2).isAlive() and iGameTurn >= gc.getPlayer(iCiv2).getBirthTurn()+15): #RFCRAND
