...
def getRealLatitude(argsList): #RFCRAND (unused?)
        return utils.getRealLatitude(argsList[0])
def getBlindSettlersMap(argsList): #RFCRAND
        return utils.blindSettlersMap(argsList[0],argsList[1],argsList[2])
def getInThisGame(argsList): #RFCRAND
        return utils.getInThisGame(argsList[0])
