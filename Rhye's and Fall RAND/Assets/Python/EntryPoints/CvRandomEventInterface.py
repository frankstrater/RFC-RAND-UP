...
def getHelpHolyMountain1(argsList):
	...
	iMinPoints = 5 + gc.getMap().getWorldSize()
	#Rhye - end
...
def canTriggerHolyMountainRevealed(argsList):
	...
	if (iNumPoints < 5 + gc.getMap().getWorldSize()):
	#Rhye - end
		return false
...
##		iMinLandmass  = 6
	if map.getWorldSize() == CvUtil.findInfoTypeNum(gc.getWorldInfo, gc.getNumWorldInfos(), 'WORLDSIZE_STANDARD'):
		iMinLandmass  = 8
...
def getHelpHorseWhispering1(argsList):
	...
	#Rhye
	iNumStables = 5 + gc.getMap().getWorldSize()
...
def canTriggerHorseWhisperingDone(argsList):
	...
	if (5 + gc.getMap().getWorldSize()) > player.getBuildingClassCount(iStable):
	#Rhye - end
		return false
...
def getHelpHorseWhisperingDone1(argsList):
	...
	#Rhye
	iNumUnits = 5 + gc.getMap().getWorldSize()
...
def getHelpHarbormaster1(argsList):
	...
	iHarborsRequired = 5 + gc.getMap().getWorldSize()
	#Rhye - end
...
def getHelpClassicLiterature1(argsList):
	...
	iLibrariesRequired = 5 + gc.getMap().getWorldSize()
	#Rhye - end
...
def canTriggerClassicLiteratureDone(argsList):
	...
	iBuildingsRequired = 5 + gc.getMap().getWorldSize()
	#Rhye - end
...
def getHelpMasterBlacksmith1(argsList):
	...
	iRequired = 5 + gc.getMap().getWorldSize()
	#Rhye - end
...
def getHelpCrusadeDone1(argsList):
	...
	iNumUnits = (7 + gc.getMap().getWorldSize()) / 2 + 1
	#Rhye - end
...
def getHelpCrusadeDone3(argsList):
	...
	iNumCities = 5 + gc.getMap().getWorldSize()
	#Rhye - end
	holyCity = gc.getGame().getHolyCity(kTriggeredData.eReligion)
...
def applyCrusadeDone3(argsList):
	...
	iNumCities = min(5 + gc.getMap().getWorldSize(), len(listCities))
	#Rhye - end
...
def getHelpWarChariots1(argsList):
	...
	iNumUnits = (5 + gc.getMap().getWorldSize()) + 1
	#Rhye - end
...
def getHelpCorporateExpansion1(argsList):
	...
	iNumCities = (5 + gc.getMap().getWorldSize()) + 1
	#Rhye - end
...
def canTriggerCorporateExpansionDone(argsList):
	...
	iNumCitiesRequired = (4 + gc.getMap().getWorldSize()) + 1 + kOrigTriggeredData.iOtherPlayerCityId
	#Rhye - end
