...
void CvCity::init(int iID, PlayerTypes eOwner, int iX, int iY, bool bBumpUnits, bool bUpdatePlotGroups)
{
	...
	if (GC.getMapINLINE().getSeaLevel() >= 3) { //very low
		if (getOwnerINLINE()<NUM_MAJOR_PLAYERS)
			eraModifier = int(GET_PLAYER(getOwnerINLINE()).getBirthTurn()/90);
		switch (getOwnerINLINE())
		{
			case SPAIN:
			case FRANCE:
...
bool CvCity::canConstruct(BuildingTypes eBuilding, bool bContinue, bool bTestVisible, bool bIgnoreCost) const
{
	...
	if (eBuilding >= NUM_BUILDINGS_PLAGUE)
	{
		...
		if ((GET_TEAM(getTeam()).isAtWar((TeamTypes)((int)eBuilding - NUM_BUILDINGS_PLAGUE))))
			return false;
		if (GC.getGameINLINE().getGameTurn() <= GET_PLAYER((PlayerTypes)(eBuilding - NUM_BUILDINGS_PLAGUE)).getBirthTurn() + 2) //RFCRAND
			return false;
...
//Speed: End Modify
	...
	if (GC.getMapINLINE().getSeaLevel() >= 3) { //very low
		if (getOwnerINLINE()<NUM_MAJOR_PLAYERS)
			low_ratio =  100+((GET_PLAYER(getOwnerINLINE()).getBirthTurn() - startingTurn[getOwnerINLINE()])/580);
	}
	...
	{
			case EGYPT:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *90 /100/100, false, true); //72 before removal of Creative trait
				break;
			case INDIA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *80 /100/100, false, true);
				break;
			case CHINA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *80 /100/100, false, true);
				break;
			case BABYLONIA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *90 /100/100, false, true);
				break;
			case GREECE:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *100 /100/100, false, true);
				break;
			case PERSIA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *100 /100/100, false, true); //100 before removal of Creative trait
				break;
			case CARTHAGE:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *100 /100/100, false, true); //100 before removal of Creative trait
				break;
			case ROME:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *100 /100/100, false, true); //was 110 but it chokes euro civs
				break;
			case JAPAN:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *90 /100/100, false, true);
				break;
			...
			case MAYA:
				...
				break;
			case VIKING:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *130 /100/100, false, true);
				break;
			case ARABIA:	
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *110 /100/100, false, true); //100 in vanilla
				break;
			case KHMER:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *120 /100/100, false, true);
				break;
			case FRANCE:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *160 /100/100, false, true); //150 in vanilla and warlords
				break;
			case SPAIN:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *125 /100/100, false, true);
				break;
			case ENGLAND:	
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *130 /100/100, false, true);
				break;
			case GERMANY:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *128 /100/100, false, true);
				break;
			case RUSSIA:				
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *130 /100/100, false, true);
				break;
			case NETHERLANDS:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *132 /100/100, false, true); //135, but it's too strong as Amsterdam is a powerhouse
				break;
			case MALI:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *130 /100/100, false, true);
				break;
			case TURKEY:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *150 /100/100, false, true); //already strong with UP
				break;
			case PORTUGAL:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *147 /100/100, false, true);
				break;
			case INCA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *140 /100/100, false, true);
				break;
			case MONGOLIA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *135 /100/100, false, true);
				break;
			case AZTEC:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *140 /100/100, false, true);
				break;
			case AMERICA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *low_ratio *165 /100/100, false, true);
				break;
			case INDEPENDENT:
			case INDEPENDENT2:
				/*if (!GET_PLAYER((PlayerTypes)EGYPT).isPlayable()) { //late start condition
