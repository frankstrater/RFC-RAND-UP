...
void CyPlayerPythonInterface2(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("AI_blindSettlersMap", &CyPlayer::AI_blindSettlersMap, "int (int iX, int iY, bool bStartingLoc)") //Rhye RFCRAND
		...
		.def("getSettlersCoords", &CyPlayer::getSettlersCoords, "int (int index)") //Rhye
		.def("getSettlersModifiers", &CyPlayer::getSettlersModifiers, "int (int index)") //Rhye
		.def("getSettlersModifiersNorm", &CyPlayer::getSettlersModifiersNorm, "int (int index)") //Rhye
		.def("setLeader", &CyPlayer::setLeader, "void (int i)") //Rhye
		.def("getLeader", &CyPlayer::getLeader, "int /*LeaderHeadTypes*/ ()") //Rhye
		.def("getBirthTurn", &CyPlayer::getBirthTurn, "int ()") //Rhye RFCRAND
		.def("setBirthTurn", &CyPlayer::setBirthTurn, "void (int i)") //Rhye RFCRAND
		;
}
