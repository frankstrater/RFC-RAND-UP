...
public:
	...
	void setMinorCiv(bool bMinorNationCiv); //Rhye RFCRAND			// Exposed to Python
	...
	//virtual int AI_blindSettlersMap(int iX, int iY, bool bStartingLoc) = 0; // Exposed to Python //Rhye RFCRAND
	...
	DllExport int getSettlersCoords(int index); //Rhye
	DllExport int getSettlersModifiers(int index); //Rhye
	DllExport int getSettlersModifiersNorm(int index); //Rhye
	...
	int AI_blindSettlersMap(int iX, int iY, bool bStartingLoc); // Exposed to Python //Rhye RFCRAND
	DllExport int getBirthTurn(); //Rhye RFCRAND
	void setBirthTurn(int iYear); //Rhye RFCRAND
...
protected:
	...
	int m_iAdditionalContactTimer; //Rhye - RFCRAND (workaround for contacts bug)
	int m_iBirthTurn; //Rhye - RFCRAND 
	...
	int* m_aisettlersModifiersNorm; //Rhye RFCRAND
